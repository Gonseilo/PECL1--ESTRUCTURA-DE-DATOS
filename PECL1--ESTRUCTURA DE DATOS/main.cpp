...
int main(){
    ...
    cout << "||------------------------|------|------|------|------||" << endl;
    cout << "||" << setw(19) << "Paquetes enviados:" << setw(6) << "|" << setw(4) << cNO.recorrerCola(tempaux) << setw(3) << "|" << setw(4) << cNE.recorrerCola(tempaux) << setw(3) << "|" << setw(4) << cSO.recorrerCola(tempaux) << setw(3) << "|" << setw(4) << cSE.recorrerCola(tempaux) << setw(4) << "||" << endl;
